...
import com.example.demo.di4.AppContext;
// import com.example.demo.di4.Car;
...
// 패키지 전체를 순회하면서 @Component 어노테이션이 달린 클래스들을 객체로
// @Autowired가 달린 필드에 컨테이너가 저장되어 있는 객체를 세팅해준다.
class AppContext {
